...
import uz.pdp.repository.WithdrawMoneyRepository;
import uz.pdp.entity.enums.BankNoteName;
import uz.pdp.payload.Result;
import uz.pdp.payload.WithdrawFromCardDto;
...
public class WithdrawFromCardService {
      ...
      public Result addWithdrawMoney(WithdrawFromCardDto withdrawDto)  {
           ...
           Optional<Atm> optionalATM = bankATMRepository.findById(withdrawDto.getAtmID());
          ...
          if (withdrawDto.getBankNote() == 1000) {
              withdrawMoney.setBankNote(BankNoteName.THOUSAND_SUM.name());
          }
          else if (withdrawDto.getBankNote() == 5000)   {
              withdrawMoney.setBankNote(BankNoteName.FIVE_THOUSAND_SUM.name());
          }
          else if (withdrawDto.getBankNote() == 10000)  {
              withdrawMoney.setBankNote(BankNoteName.TEN_THOUSAND_SUM.name());
          }
          else if (withdrawDto.getBankNote() == 50000)  {
              withdrawMoney.setBankNote(BankNoteName.FIFTY_THOUSAND_SUM.name());
          }
          else if (withdrawDto.getBankNote() == 100000) {
              withdrawMoney.setBankNote(BankNoteName.HUNDRED_THOUSAND_SUM.name());
          }
          else if (withdrawDto.getBankNote() == 1)   {
              withdrawMoney.setBankNote(BankNoteName.ONE_DOLLAR.name());
          }
          else if (withdrawDto.getBankNote() == 5)   {
              withdrawMoney.setBankNote(BankNoteName.FIVE_DOLLAR.name());
          }
          else if (withdrawDto.getBankNote() == 10)  {
              withdrawMoney.setBankNote(BankNoteName.TEN_DOLLAR.name());
          }
          else if (withdrawDto.getBankNote() == 20)  {
              withdrawMoney.setBankNote(BankNoteName.TWENTY_DOLLAR.name());
          }
          else if (withdrawDto.getBankNote() == 50)  {
              withdrawMoney.setBankNote(BankNoteName.FIFTY_DOLLAR.name());
          }
          else if (withdrawDto.getBankNote() == 100) {
              withdrawMoney.setBankNote(BankNoteName.HUNDRED_DOLLAR.name());
          }
          else {
          ...
          // IF MONEY IS LOW AT ATM, YOU WILL TAKE A SMS.
